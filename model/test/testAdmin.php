<?php
	...
	$afficheEmployee = new User(99 ,'VerrillDuplessis@jourrapide.com' ,'Duplessis' ,'Verrill' ,'90, Rue Frédéric Chopin' ,27200 ,'VERNON' , 'testEmployee', 'test', '02.33.88.84.19', 5, "VideoStore");
	var_dump($afficheEmployee);
